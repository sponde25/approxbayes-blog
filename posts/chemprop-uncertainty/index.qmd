...
description: "Benchmarking MC Dropout, MVE Ensembles, and Stochastic Variational Deep Kernel Learning for uncertainty-guided active learning on ~900k molecular docking datasets."
author: "Anirudh Jain"
date: "2025-04-10"
...
- `models.py` — model wrappers for MC Dropout, MVEE, and SVDKL (including `SVDKLLightningModule`).
- `acquisition.py` — clustering and uncertainty-diverse acquisition function.
- `toy_example.ipynb` — 1D sine-wave toy example demonstrating SVDKL posterior behaviour.
